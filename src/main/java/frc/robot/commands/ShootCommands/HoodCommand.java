...
public class HoodCommand extends PIDCommand {
  ...
  public HoodCommand(HoodSubsystem hoodSub, LimelightSubsystem limeSub) {

    super(
        // The controller that the command will use
        new PIDController(0.02, 0.007, 0),
        // This should return the measurement
        () -> hoodSub.getAngle(),
        // This should return the setpoint (can also be a constant)
        () -> SmartDashboard.getNumber("Hood Angle input", 14), //InterpolatingTable.getShotParameter(limeSub.getDistance()).getHoodAngle(),
